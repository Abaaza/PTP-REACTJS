...
export default function ProductList() {
  ...
  const handlePrintTag = (id) => {
    ...
    window.open(`https://qxxaz9rivc.execute-api.me-south-1.amazonaws.com/dev/api/pdf/tag/${id}/${qty}`, "_blank");
  };
  ...
  const handleBulkPrint = async () => {
    ...
    try {
      const res = await fetch("https://qxxaz9rivc.execute-api.me-south-1.amazonaws.com/dev/api/pdf/print-bulk", {
        method: "POST",
